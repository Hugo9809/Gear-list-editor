...
const ProjectWorkspace = ({
  ...
  const handleConfirmSaveTemplate = (e) => {
    e.preventDefault();
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {activeProject && (
              <>
                ...
                <button type="button" onClick={handleSaveTemplateClick} className="ui-button ui-button-outline">
                ...
                <button
                  ...
                  className={`ui-button px-3 py-1 transition-colors ${isDeleting
        ...
        isSavingTemplate && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" role="dialog">
            <form
              ...
              className="w-full max-w-md flex flex-col gap-4 rounded-xl border border-surface-sunken bg-surface-elevated p-6 shadow-2xl"
            >
              <div>
                <h3 className="text-lg font-semibold ui-heading">
                  {t('template.actions.saveFromProject', 'Save as template')}
                ...
                <p className="text-sm text-text-secondary">
                  {t('template.save.description', 'Create a reusable template from this project.')}
                </p>
              </div>
              <label className="flex flex-col gap-2 text-sm text-text-secondary">
                ...
                <input
                  ...
                  className="ui-input ui-input-lg w-full"
                  placeholder={t('template.placeholders.name', 'My Template')}
                />
              </label>
